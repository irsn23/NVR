...
if __name__ == "__main__":
    r = requests.get('https://api.live.bilibili.com/xlive/web-interface/v1/second/getList?platform=web&parent_area_id=9&area_id=0&sort_type=sort_type_291&page=2',headers=kv)
    print(r.headers)
    print(r)
